...
const MovieSection = ({ 
    ...
    const isRecommendedSection = title === '내가 추천하는 영화';
        ...
        <div className="relative -mx-4 md:-mx-2">
          <div 
            ...
            style={{
              ...
              paddingLeft: isRecommendedSection ? '16px' : 'max(16px, calc(50% - 150px))',
              paddingRight: isRecommendedSection ? '16px' : 'max(16px, calc(50% - 150px))',
            }}
          >
            {movies.map((movie) => (
              <div 
